...
public class NguoiDungDao {
    ...
    public void updatePassword(NguoiDung model) {
    ...
    public List<NguoiDung> selectByKeywordKhachHang(String key1, String key2, String key3, String key4, String key5, String key6) {
        String sql = "Select * FROM NguoiDung \n"
                + "where (HoTen like ? or maNguoiDung like ? or DiaChi like ? or Email like ? or SoDienThoai like ? or ngaySinh like ?) and vaitro = 0";
        return select(sql, "%" + key1 + "%", "%" + key2 + "%", "%" + key3 + "%", "%" + key4 + "%", "%" + key5 + "%", "%" + key6 + "%");
    }
    
    public List<NguoiDung> selectByKeywordNhanVien(String key1, String key2, String key3, String key4, String key5, String key6) {
        String sql = "Select * FROM NguoiDung \n"
                + "where (HoTen like ? or maNguoiDung like ? or DiaChi like ? or Email like ? or SoDienThoai like ? or ngaySinh like ?) and vaitro = 1";
        return select(sql, "%" + key1 + "%", "%" + key2 + "%", "%" + key3 + "%", "%" + key4 + "%", "%" + key5 + "%", "%" + key6 + "%");
    }
